...
const patterns: Pattern[] = [
    ...
    - Never make promises about refunds or policy changes"""
        ...
        relatedPatterns: ["role-based-agents"],
    },
...
router_agent = Agent(
    ...
    Handle yourself: general questions, product information""",
    handoffs=[billing_agent, technical_agent]
        ...
        relatedPatterns: ["clear-instructions"],
    },
...
def get_order_status(order_id: str) -> str:
    ...
    try:
        ...
        if response.status_code == 200:
            order = response.json()
            return f"Order {order_id}: {order['status']} - Expected delivery: {order['delivery_date']}"
        else:
...
def get_product_info(product_id: str) -> str:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return f"Product: {product['name']} - Price: $" + str(product['price'])
...
agent = Agent(
    ...
    When using the product info tool, explain any errors clearly and suggest next steps.
    ...
    tools=[get_product_info]
        ...
        relatedPatterns: ["function-tool-integration"],
    },
...
def get_product_details(product_id: str) -> str:
    ...
    try:
        ...
        if response.status_code == 200:
            product = response.json()
            result = f"Product: {product['name']} - $" + str(product['price'])
