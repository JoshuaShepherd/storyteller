                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <RadioGroup
                                    value={intakeData.operatingSystem}
                                ...
                                >
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <RadioGroupItem
                                            ...
                                            id="other-os"
                                        />
                                        <Label htmlFor="other-os">Other</Label>
                                    </div>
                                </RadioGroup>
                            </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <RadioGroup
                                    value={intakeData.aiExperience.currentUsage}
                                    onValueChange={(value: string) =>
                                        handleInputChange(
                                            "currentUsage",
                                            value,
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <RadioGroup
                                    value={intakeData.preferredPace}
                                    onValueChange={(value: string) =>
                                        handleInputChange(
                                            "preferredPace",
                                            value
