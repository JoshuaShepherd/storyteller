                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Track your progress and the impact of your AI
                                learning journey
                            </CardDescription>
                        </div>
                        <Button
                        ...
                        <div>
                            ...
                            {isEditing ? (
                                ...
                                <div className="text-2xl font-bold text-blue-600">
                                    {metrics.timeSaved.weekly}{" "}
                                    {metrics.timeSaved.unit}/week
                                </div>
                            )}
                        </div>
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value="cost-savings">
                                                Cost Savings
                                            </SelectItem>
                                            <SelectItem value="revenue-increase">
                                                Revenue Increase
                                            </SelectItem>
                                            <SelectItem value="efficiency-gain">
                                                Efficiency Gain
                                            </SelectItem>
                                        </SelectContent>
                                    </Select>
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        value={
                                            metrics.financialImpact.description
                                        }
                                        onChange={(e) =>
                                            handleUpdateBasicMetrics({
                                                financialImpact: {
                        ...
                        >
                            ...
                            {isEditing && (
                                <Button
                                    ...
                                    variant="ghost"
                                    onClick={() =>
                                        handleRemoveCustomMetric(metric.id)
                                    }
                                >
                                    <X className="h-4 w-4" />
                                </Button>
                    ...
                    {metrics.customMetrics.length === 0 &&
                        !isAddingCustomMetric && (
                            <div className="text-center py-6 text-gray-500">
                                ...
                                {isEditing &&
                                    "Click 'Add Metric' to create one."}
                            </div>
                        )}
                </CardContent>
            </Card>
                ...
                <Card className="border-orange-200 bg-orange-50">
                    ...
                    <CardContent>
                        <p className="text-sm text-orange-700">
                            Track quantifiable improvements in the student's
                            confidence, skills, and productivity. These metrics
                            help demonstrate the concrete value of AI learning
                            and can guide future coaching focus areas.
                        </p>
                    </CardContent>
                </Card>
            )}
